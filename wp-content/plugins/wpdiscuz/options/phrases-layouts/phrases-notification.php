    ...
    <table class="wp-list-table widefat plugins" style="margin-top:10px; border:none;">
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_log_in"]); ?>"
                                   name="wc_log_in" id="wc_log_in"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            <th scope="row"><label for="wc_you_must_be_text"><?php esc_html_e("You must be", "wpdiscuz"); ?></label>
            </th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_you_must_be_text"]); ?>"
                                   name="wc_you_must_be_text" id="wc_you_must_be_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_logged_in_text"><?php esc_html_e("Logged In", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_logged_in_text"]); ?>"
                                   name="wc_logged_in_text" id="wc_logged_in_text"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
        ...
        <tr valign="top">
            ...
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_logged_in_as"]); ?>"
                                   name="wc_logged_in_as" id="wc_logged_in_as"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_log_out"><?php esc_html_e("Log out", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_log_out"]); ?>"
                                   name="wc_log_out" id="wc_log_out"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_vote_counted"><?php esc_html_e("Vote Counted", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_vote_counted"]); ?>"
                                   name="wc_vote_counted" id="wc_vote_counted"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label for="wc_login_to_vote"><?php esc_html_e("Login To Vote", "wpdiscuz"); ?></label></th>
            <td colspan="3"><input type="text" value="<?php echo esc_attr($this->phrases["wc_login_to_vote"]); ?>"
                                   name="wc_login_to_vote" id="wc_login_to_vote"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_awaiting_for_approval" id="wc_awaiting_for_approval"/></td>
        </tr>
        <tr valign="top">
            <th scope="row"><label
            ...
            <td colspan="3"><input type="text"
                                   ...
                                   name="wc_roles_cannot_comment_message" id="wc_roles_cannot_comment_message"/></td>
        </tr>
        </tbody>
    </table>
</div>